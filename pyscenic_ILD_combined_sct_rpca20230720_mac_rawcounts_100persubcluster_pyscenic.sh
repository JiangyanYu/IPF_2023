docker run -it --rm \
    ...
    aertslab/pyscenic_scanpy:0.12.1_1.9.1 pyscenic grn \
        --num_workers 26 \
        -o /data/IPF/include_prolif/expr_mat.adjacencies.tsv \
        /data/IPF/include_prolif/ILD_combined_sct_rpca20230720_mac_rawcounts_100persubcluster_scenic.loom \
        /data/resources/allTFs_hg38_lastmodi20220427.txt

docker run -it --rm \
    -v /media/agschlitzer/DATA1/SCENIC:/data \
    aertslab/pyscenic_scanpy:0.12.1_1.9.1 pyscenic ctx \
        /data/IPF/include_prolif/expr_mat.adjacencies.tsv \
        ...
        --expression_mtx_fname /data/IPF/include_prolif/ILD_combined_sct_rpca20230720_mac_rawcounts_100persubcluster_scenic.loom \
        --mode "custom_multiprocessing" \
        --output /data/IPF/include_prolif/regulons.csv \
        --num_workers 26
...
docker run -it --rm \
    ...
    aertslab/pyscenic_scanpy:0.12.1_1.9.1 pyscenic aucell \
        /data/IPF/include_prolif/ILD_combined_sct_rpca20230720_mac_rawcounts_100persubcluster_scenic.loom \
        /data/IPF/include_prolif/regulons.csv \
        -o /data/IPF/include_prolif/auc_mtx.csv \
        --num_workers 26        
